                        ...
                        id="form_produto_insere">
                            ...
                            <div class="input-group">
                                <label for="destaque_produto_s" class="radio-inline">
                                    <input type="radio" name="destaque_produto" id="destaque_produto" value="Sim" <?php echo $row['destaque_produto']=="Sim"?"checked":null ?> >
                                </label>
                                <label for="destaque_produto_n" class="radio-inline">
                                    <input type="radio" name="destaque_produto" id="destaque_produto" value="Não" <?php echo $row['destaque_produto']=="Sim"?"checked":null ?> >
                                </label>
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                class="form-control" placeholder="Digite os detalhes do Produto" 
                                 ><?php $row['resumo_produto'];?></textarea>
                            </div>
