    ...
    <div class="row panel-footer fundo-rodape">
        ...
        <div class="col-sm-6 col-md-4">
            <div class="panel-footer" style="background:none;">
                <img src="images/Chuleta Quente.png" alt="logo_pequeno" >
                <br>
                ...
                <address>
                    ...
                    &nbsp;
                    <a href="mailto:contato@chuletaquente.com.br?subject=Contato do Site&cc=daniel.ds5676419@gmailcom">
                        contato@chuletaquente.com.br
                    </a>
                </address>
                <div class="embed-responsive embed-responsive-4by3">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3657.7948465173113!2d-46.45864738440706!3d-23.53988006668587!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94ce66bf222d207b%3A0x1939a901dce47f36!2sAv.%20Itaquera%2C%208266%20-%20Vila%20Carmosina%2C%20S%C3%A3o%20Paulo%20-%20SP%2C%2008295-000!5e0!3m2!1spt-BR!2sbr!4v1674235681600!5m2!1spt-BR!2sbr" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>                </div>
            </div>
        </div>
                ...
                <ul class="nav nav-pill nav-stacked">
                    ...
                    <li>
                        <a href="index.php#destaques" class="text-danger">
                            <span class="glyphicon glyphicon-ok-sign" aria-hidden="true">&nbsp;Destaque</span>
                        </a>
                    </li>
                    <li>
        ...
        <div class="col-sm-12">
            ...
            <h6 class="text-danger text-center">
                Desenvolvido por Danielsoliveira44; 2023
                <br>
                <a href="https://www.danielsoliveira44.com.br" target="_blank">danielsoliveira44.com.br</a>
            </h6>
            </div>
        </div>
    </div>
